...
\subsubsection {Parte 1}
 ...
 En esta parte, teníamos que implementar la función de coste y la de gradiente de la regresión lineal regularizada para estos datos. Al hacerlos, obtuvimos un coste de 303.993, y un gradiente en el rango [-15.241, 598.250].

 Después, utilizamos la función scipy.optimize.minimize, como se pedía en el enunciado, para minimizar el error sobre los ejemplos de entrenamiento. Al hacerlos, con un valor λ = 0, obtuvimos un vector que define la siguiente recta:
